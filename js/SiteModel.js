	...
	function SiteModel(require) {
		...
		function LoadModels(){
			...
			var _models=[
				...
				'./js/models/PacketGet.js',
				'./js/models/BrandModel.js',
				'./js/models/BrandInfroModel.js',
				'./js/models/BrandPlaceModel.js',
				'./js/models/BrandLandModel.js',
				'./js/models/BrandVarModel.js',
				'./js/models/BrandTasteInfoModel.js',
