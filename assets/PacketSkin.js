...
lib.ssMetadata = [
		{name:"PacketSkin_atlas_", frames: [[51,902,43,42],[186,876,49,42],[0,902,49,42],[0,0,543,874],[0,876,184,24]]}
];
...
(lib.补间21 = function(mode,startPosition,loop) {
	...
	// 图层 1
	this.text = new cjs.Text("领 取 福 利", "28px 'Microsoft YaHei'");
	this.text.textAlign = "center";
	this.text.lineHeight = 39;
	this.text.lineWidth = 155;
	this.text.parent = this;
	this.text.setTransform(0,-41.9);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-79.3,-43.9,158.6,88);
...
(lib.补间19 = function(mode,startPosition,loop) {
	...
	// 图层 1
	this.text = new cjs.Text("关 注 微 信", "28px 'Microsoft YaHei'");
	this.text.textAlign = "center";
	this.text.lineHeight = 39;
...
p.nominalBounds = new cjs.Rectangle(-72.8,-23,145.8,46.2);
...
(lib.PacketSkin = function(mode,startPosition,loop) {
	...
	this.instance_5.setTransform(320,228,0.3,0.3,0,0,0,0.1,0.1);
	this.instance_5._off = true;

	this.instance_6 = new lib.补间21("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(320,228);
	...
	this.instance_7.setTransform(320.3,171,0.3,0.3,0,0,0,0.7,0.7);
	this.instance_7._off = true;

	this.instance_8 = new lib.补间19("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(320.3,171);
